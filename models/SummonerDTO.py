...
class SummonerDTO(BaseModel):
    ...
    id: str = Field(
        ...
        example="OWjT1dt-lDb7Be0bSqcDJz3h9wdJEfkgf1OQjlKWKYmn138",
    )
    accountId: str = Field(
        description="Encrypted account ID. Legacy identifier maintained for backwards compatibility.",
        example="EBBi1JBAgp-kqxQUnk04ZyCfehwDukJRD3OoNTWyDfkzFxk",
    )
    puuid: str = Field(
        description="Player Universally Unique Identifier. A unique identifier for the player across all Riot games.",
        example="zk1tF-l0TT1SrT9SbUmofKLT4R2gLKxzhGSyNuuxTCbmjr6dOqTCw1GcYrHoRp5DV2f5M17GMLPEFw",
    )
    ...
    revisionDate: int = Field(
        ...
        example=1731621546313,
    )
    summonerLevel: int = Field(
        description="Experience level of the summoner account.", example=367
    )
